        ...
        <div class="loginform">
          ...
          <div class="content">
            <form action="##">
              ...
              <!-- prevent:阻止默认行为，也就是阻止点击button之后表单（form）自动提交的行为 -->
              <button class="btn"
...
export default {
  ...
  methods: {
    //【可以用这个账号登录】phone:qweqweqwe,password:qwe
    //【这个账号有收件人信息】phone：13700000000，password：111111
    async userLogin() {
      try {
        ...
        //登录的路由组件：看路由中有没有query，如果有，就重定向到query参数所指向的地方，如果没有就跳到home。
